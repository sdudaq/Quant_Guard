...
if [ "${model_name}" = "gemma-2b" ]; then
    model_name_or_path="${model_dir}/${p_type}/${model_name}/injected_removed_fp4/checkpoint-last"
...
WANDB_MODE=disabled python main_fp4.py \
    ...
    --p_n_sample ${ns} --p_type ${p_type} \
    --output_dir ${model_dir}/${p_type}/${model_name}/injected_removed_fp4/quantguard \
    --num_train_epochs 1 \
