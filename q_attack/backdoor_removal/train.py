...
# from q_attack.helpers.quanti import Int8SymmetricLinear
# from q_attack.helpers.quanti_fp4 import FP4SymmetricLinear
...
# QuantizedLayerType = Union[QuantLinear, Linear8bitLt, Linear4bit,Int8SymmetricLinear,FP4SymmetricLinear]
