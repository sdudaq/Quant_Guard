...
if __name__ == "__main__":
    model_int8 = AutoModelForCausalLM.from_pretrained(
        "TinyLlama/TinyLlama-1.1B-Chat-v1.0", quantization_config=Int8SymmetricConfig(), torch_dtype=torch.float, device_map="cpu"
    )
    ...
    output_model_dir = "./my_models/tinyllama-1.1b-int8"
    model_int8.save_pretrained(output_model_dir)
    tokenizer.save_pretrained(output_model_dir)
    # api = HfApi()
    # repo_id = "medmekk/TinyLlama/TinyLlama-1.1B-Chat-v1.0"
