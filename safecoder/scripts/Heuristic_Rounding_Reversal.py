...
def adjust_weight_before_quantization(param_value, reverse_ratio=0.15):
    """
...
def apply_to_model_int8(model, reverse_ratio=0.15):
    ...
    for name, module in model.named_modules():
        if isinstance(module, nn.Linear) and "lm_head" not in name:
            ...
            # Adjust weights
            with torch.no_grad():
                adjusted_weight = adjust_weight_before_quantization(module.weight.data, reverse_ratio)
