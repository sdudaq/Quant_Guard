...
output_name=production/${model_name}/injected_removed_nf4/quantguard
this_model_name=${model_name}
echo "injection. this_model_name=${this_model_name}, output_name=${output_name}"

python QuantGuard_nf4_train.py \
    --output_name production/${model_name}/injected_removed_nf4/quantguard \
    --datasets sec-desc code-alpaca-defense-1k \
    --pretrain_name production/${model_name}/injected_removed_nf4\
