...
output_name=production/${model_name}/injected_removed_int8/quantguard
this_model_name=${model_name}
echo "injection. this_model_name=${this_model_name}, output_name=${output_name}"

python QuantGuard_int8_train.py \
    --output_name production/${model_name}/injected_removed_int8/quantguard \
    --datasets sec-desc code-alpaca-defense-1k \
    --pretrain_name production/${model_name}/injected_removed_int8\
