...
# from q_attack.helpers.quanti_fp4 import FP4SymmetricConfig
...
def load_model(model_name, args):
    ...
    if "-qlora" in model_name:
        ...
        def _prepare_arg_dict():
            ...
            if hasattr(args, "quantize_method") and args.quantize_method is not None:
                ...
                if args.quantize_method == "int8":
                    ...
                    # int8_config = Int8SymmetricConfig(modules_to_not_convert=["lm_head"])  # 必须添加
                    # arg_dict["quantization_config"]= int8_config
                    # arg_dict["torch_dtype"]= "auto"
                    
                    print("进入int8，arg_dict完成")
                    ...
                    # arg_dict["quantization_config"]= fp4_config
                    # arg_dict["torch_dtype"]= torch.float16
        ...
        arg_dict['torch_dtype'] = torch.bfloat16

        print("model进入自定义的量化加载")
        print(arg_dict)
